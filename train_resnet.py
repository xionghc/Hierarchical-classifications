...
def train_resnet(args, num_classes,feature_extract=True, use_pretrained=True):
    """
    Train resnet with softmax classifier.
    :param num_classes:
    :param feature_extract: (bool) If 'False', train from scratch.
    :param use_pretrained: use pretrained model.
    :return:
    """
    # parameters
